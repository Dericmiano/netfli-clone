...
const Modal = () => {
  ...
  return (
    <MuiModal open={showModel} onClose={handleClose} className="fixex !top-7 left-0
     right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll rounded-md
      scrollbar-hide ">
      <>
      ...
      <div className="relative pt-[56.25%]">
          <ReactPlayer
            ...
            muted={muted}
          />
          <div className='absolute bottom-10 flex w-ful  items-centre justify-between px-10'> 
      ...
      <div className='space-y-6 text-lg'>
        <div className='flex items-center space-x-2 text-sm'>
          ...
          <div className='flex h-4 items-centre justify-center
        ...
        <div className='flex flex-col gap-x-10 gap-y-10 font-light md:flex-row
          ...
          <div>
            <span className='text-[gray]'>Origina Language: </span>
